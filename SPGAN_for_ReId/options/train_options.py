...
class TrainOptions(BaseOptions):
    def __init__(self):
        ...
        self.parser.add_argument('--epoch_count', type=int, default=1, help='the starting epoch count, we save the model by <epoch_count>, <epoch_count>+<save_latest_freq>, \
                                    when set continue_train, the value will be load from the checkpoint.')
        self.parser.add_argument('--which_epoch', type=str, default='latest', help='which epoch to load? set to latest to use latest cached model')
        self.parser.add_argument('--niter', type=int, default=6, help='# of iter at starting learning rate')
        ...
        self.parser.add_argument('--lambda_identity', type=float, default=5,
        ...
        self.parser.add_argument('--lambda_metric', type=float, default=2.0, help='weight for metric loss')
        self.parser.add_argument('--margin', type=float, default=2.0, help='margin for metric loss')
