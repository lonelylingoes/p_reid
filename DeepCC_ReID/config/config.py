...
class Config(object):
  def __init__(self):
    ...
    parser.add_argument('--ids_per_batch', type=int, default=18)
    ...
    parser.add_argument('-gm', '--global_margin', type=float, default=1)
    parser.add_argument('-lm', '--local_margin', type=float, default=1)
    ...
    self.im_resize_size = (280, 140)
    self.im_crop_size = (256, 128)

    self.random_rotation_degree = 5
    # will scale by 1/255
