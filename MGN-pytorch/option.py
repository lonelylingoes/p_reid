...
parser.add_argument('--color_jitter', action='store_true', help='use color jitter for data augment.')
parser.add_argument('--color_augment', action='store_true', help='use color augment for data augment.')
